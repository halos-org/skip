...
export class WidgetService {
  ...
  private readonly _componentTypeMap: Record<string, () => Promise<Type<unknown>>> = {
    ...
    WidgetRacerLineViewComponent: () => import('../../widgets/widget-racer-line-view/widget-racer-line-view.component').then(m => m.WidgetRacerLineViewComponent),
  ...
  private readonly _widgetDefinition: readonly WidgetDescription[] = [
    ...
    },
    {
      ...
      componentClassName: 'WidgetRacerLineViewComponent',
    },
    {
