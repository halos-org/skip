...
export type TGraphAxisPosition = 'left' | 'right';
...
export interface IDualAxisWidgetGraphMeta {
...
export const ELECTRICAL_DUAL_AXIS_WIDGET_META: Readonly<Record<TDualAxisWidgetType, IDualAxisWidgetGraphMeta>> = {
  'widget-bms': {
...
export function getElectricalWidgetChartMeta(widgetType: TDualAxisWidgetType): IDualAxisWidgetGraphMeta {
...
export function resolveDualAxisWidgetTypeFromSeries(
...
export function describeElectricalDualAxisSeries(normalizedPath: string): IDualAxisSeriesDescriptor | null {
  for (const [widgetType, chartMeta] of Object.entries(ELECTRICAL_DUAL_AXIS_WIDGET_META) as [TDualAxisWidgetType, IDualAxisWidgetGraphMeta][]) {
