...
describe('create-host2-widget schematic', () => {
    ...
    it('generates widget files', async () => {
        ...
        expect(tree.exists('src/app/widgets/widget-alpha/widget-alpha.component.ts')).toBe(true);
    });
    ...
    it('skips registration when registerWidget = no', async () => {
        ...
        expect(tree.exists('src/app/widgets/widget-gamma/widget-gamma.component.ts')).toBe(true);
    });
});
