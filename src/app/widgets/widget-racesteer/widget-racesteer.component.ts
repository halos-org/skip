...
export class WidgetRacesteerComponent implements OnDestroy {
  ...
  public static readonly DEFAULT_CONFIG: IWidgetSvcConfig = {
    ...
    paths: {
      headingPath: { description: 'True Heading', path: 'self.navigation.headingTrue', source: 'default', pathType: 'number', isPathConfigurable: true, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false, sampleTime: 500 },
      tackTrue: { description: 'True Tack', path: 'self.performance.tackTrue', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: true, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false, sampleTime: 500 },
      polarSpeedRatio: { description: 'Polar Speed Ratio', path: 'self.performance.polarSpeedRatio', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, convertUnitTo: 'ratio', showConvertUnitTo: false, sampleTime: 500 },
      targetAngle: { description: 'Target Angle', path: 'self.performance.targetAngle', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, convertUnitTo: 'deg', showConvertUnitTo: false, sampleTime: 500 },
      optimalWindAngle: { description: 'Optimal Wind Angle', path: 'self.performance.optimumWindAngle', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, convertUnitTo: 'deg', showConvertUnitTo: false, sampleTime: 500 },
      ...
      appWindAngle: { description: 'Apparent Wind Angle', path: 'self.environment.wind.angleApparent', source: 'default', pathType: 'number', isPathConfigurable: true, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false, sampleTime: 500 },
      ...
      trueWindAngle: { description: 'True Wind Angle', path: 'self.environment.wind.angleTrueWater', source: 'default', pathType: 'number', isPathConfigurable: true, pathRequired: false, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false, sampleTime: 500 },
      ...
      courseOverGround: { description: 'True Course Over Ground', path: 'self.navigation.courseOverGroundTrue', source: 'default', pathType: 'number', isPathConfigurable: true, pathRequired: false, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false, sampleTime: 500 },
      nextWaypointBearing: { description: 'Next Waypoint True Bearing', path: 'self.navigation.course.calcValues.bearingTrue', source: 'default', pathType: 'number', isPathConfigurable: true, pathRequired: false, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false, sampleTime: 500 },
      ...
      set: { description: 'True Drift Set', path: 'self.environment.current.setTrue', source: 'default', pathType: 'number', isPathConfigurable: true, pathRequired: false, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false, sampleTime: 500 },
