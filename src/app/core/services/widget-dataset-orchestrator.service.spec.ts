...
describe('WidgetDatasetOrchestratorService', () => {
    ...
    let datasetSpy: {
        ...
        removeIfExists: ReturnType<typeof vi.fn>;
        list: ReturnType<typeof vi.fn>;
    };

    beforeEach(() => {
        datasetSpy = {
            getDatasetConfig: vi.fn().mockName("DatasetStreamService.getDatasetConfig"),
            create: vi.fn().mockName("DatasetStreamService.create"),
            edit: vi.fn().mockName("DatasetStreamService.edit"),
            removeIfExists: vi.fn().mockName("DatasetStreamService.removeIfExists"),
            list: vi.fn().mockName("DatasetStreamService.list")
        };
    ...
    it('creates Data Chart dataset when missing', () => {
        datasetSpy.getDatasetConfig.mockReturnValue(undefined);
    ...
    it('edits existing Data Chart dataset when config changes', () => {
        ...
        datasetSpy.getDatasetConfig.mockReturnValue(existing);
    ...
    it('removes owned datasets by exact uuid and prefix', () => {
        datasetSpy.list.mockReturnValue([
