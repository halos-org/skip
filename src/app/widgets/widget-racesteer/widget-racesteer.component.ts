...
export class WidgetRacesteerComponent implements OnDestroy {
  ...
  public static readonly DEFAULT_CONFIG: IWidgetSvcConfig = {
    ...
    paths: {
      ...
      nextWaypointBearing: { description: 'Next Waypoint True Bearing', path: 'self.navigation.course.calcValues.bearingTrue', source: 'default', pathType: 'number', isPathConfigurable: true, pathRequired: false, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', sampleTime: 500 },
