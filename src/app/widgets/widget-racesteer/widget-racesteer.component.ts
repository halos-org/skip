...
export class WidgetRacesteerComponent implements OnDestroy {
  ...
  public static readonly DEFAULT_CONFIG: IWidgetSvcConfig = {
    ...
    paths: {
      headingPath: { description: 'Heading', pathOptions: [{ label: 'True', path: 'self.navigation.headingTrue' }, { label: 'Magnetic', path: 'self.navigation.headingMagnetic' }], path: 'self.navigation.headingTrue', source: 'default', pathType: 'number', isPathConfigurable: true, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false },
      tackTrue: { description: 'True Tack', path: 'self.performance.tackTrue', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: true, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false },
      polarSpeedRatio: { description: 'Polar Speed Ratio', path: 'self.performance.polarSpeedRatio', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, convertUnitTo: 'ratio', showConvertUnitTo: false },
      targetAngle: { description: 'Target Angle', path: 'self.performance.targetAngle', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, convertUnitTo: 'deg', showConvertUnitTo: false },
      optimalWindAngle: { description: 'Optimal Wind Angle', path: 'self.performance.optimumWindAngle', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, convertUnitTo: 'deg', showConvertUnitTo: false },
      targetVMG: { description: 'Target Velocity Made Good', path: 'self.performance.targetVelocityMadeGood', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, convertUnitTo: 'knots' },
      VMG: { description: 'Velocity Made Good', path: 'self.performance.velocityMadeGood', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, convertUnitTo: 'knots' },
      appWindAngle: { description: 'Apparent Wind Angle', path: 'self.environment.wind.angleApparent', source: 'default', pathType: 'number', isPathConfigurable: false, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false },
      appWindSpeed: { description: 'Apparent Wind Speed', path: 'self.environment.wind.speedApparent', source: 'default', pathType: 'number', isPathConfigurable: false, pathSkUnitsFilter: 'm/s', convertUnitTo: 'knots' },
      trueWindAngle: { description: 'Wind Angle', pathOptions: [{ label: 'Water', path: 'self.environment.wind.angleTrueWater' }, { label: 'Ground', path: 'self.environment.wind.angleTrueGround' }], path: 'self.environment.wind.angleTrueWater', source: 'default', pathType: 'number', isPathConfigurable: true, pathRequired: false, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false },
      trueWindSpeed: { description: 'True Wind Speed', path: 'self.environment.wind.speedTrue', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, pathSkUnitsFilter: 'm/s', convertUnitTo: 'knots' },
      courseOverGround: { description: 'Course Over Ground', pathOptions: [{ label: 'True', path: 'self.navigation.courseOverGroundTrue' }, { label: 'Magnetic', path: 'self.navigation.courseOverGroundMagnetic' }], path: 'self.navigation.courseOverGroundTrue', source: 'default', pathType: 'number', isPathConfigurable: true, pathRequired: false, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false },
      nextWaypointBearing: { description: 'Next Waypoint True Bearing', path: 'self.navigation.course.calcValues.bearingTrue', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false },
      vmgToWaypoint: { description: 'Velocity Made Good to Waypoint', path: 'self.performance.velocityMadeGoodToWaypoint', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, convertUnitTo: 'knots' },
      set: { description: 'True Drift Set', path: 'self.environment.current.setTrue', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, pathSkUnitsFilter: 'rad', convertUnitTo: 'deg', showConvertUnitTo: false },
      drift: { description: 'Drift Speed Impact', path: 'self.environment.current.drift', source: 'default', pathType: 'number', isPathConfigurable: false, pathRequired: false, pathSkUnitsFilter: 'm/s', convertUnitTo: 'knots' }
    },
