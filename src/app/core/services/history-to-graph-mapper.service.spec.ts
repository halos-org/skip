...
describe('HistoryToGraphMapperService', () => {
  let service: HistoryToGraphMapperService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [HistoryToGraphMapperService]
    });

    service = TestBed.inject(HistoryToGraphMapperService);
  });
  ...
  it('does not graph a lone :sma column as the Value series', () => {
    const response: IHistoryValuesResponse = {
      context: 'vessels.self',
      range: {
        from: '2026-02-16T00:00:00.000Z',
