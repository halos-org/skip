 ...
 *  - app.configVersion 18 (LATEST_APP_CONFIG_VERSION)
...
export function appConfig(extra = {}) {
  // configVersion at LATEST (18): a genuine current config, so the boot skips
  ...
  return {
    configVersion: 18, autoNightMode: false, redNightMode: false, nightModeBrightness: 0.27,
