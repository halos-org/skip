...
describe('WidgetHistoryGraphDialogComponent', () => {
  ...
  let component: WidgetHistoryGraphDialogComponent;
  ...
  const seriesDefinitions: ISkipSeriesDefinition[] = [
    {
      ...
      seriesUuid: 'widget-bms-1:bms:battery-1:capacity.stateOfCharge:default',
    ...
    },
    {
      ...
      seriesUuid: 'widget-bms-1:bms:battery-1:current:default',
      ownerWidgetUuid: 'widget-bms-1',
      ownerWidgetSelector: 'widget-bms',
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [WidgetHistoryGraphDialogComponent],
      providers: [
        {
  ...
  it('uses series-order dash with metric-order colors across multiple BMS entities', async () => {
    const bmsSeries: ISkipSeriesDefinition[] = [
      ...
      },
      {
        ...
        seriesUuid: 'widget-bms-1:bms:battery-2:capacity.stateOfCharge:default',
        ownerWidgetUuid: 'widget-bms-1',
        ownerWidgetSelector: 'widget-bms',
      ...
      },
      {
        ...
        seriesUuid: 'widget-bms-1:bms:battery-2:current:default',
        ownerWidgetUuid: 'widget-bms-1',
        ownerWidgetSelector: 'widget-bms',
  ...
  it('builds dual y-axes for BMS graphs and colors axis titles by metric', () => {
    (component as unknown as {
      pendingDatasets: {
        yAxisID?: string;
      }[];
  ...
  it('classifies solar panelPower/current on dual axes, converts power W to kW, and keeps first-entity lines solid', async () => {
    ...
    const panelPowerSeries: ISkipSeriesDefinition = {
      ...
      seriesUuid: 'widget-solar-1:solar:charger-1:panelPower:default',
    ...
    const currentSeries: ISkipSeriesDefinition = {
      ...
      seriesUuid: 'widget-solar-1:solar:charger-1:current:default',
      ownerWidgetUuid: 'widget-solar-1',
      ownerWidgetSelector: 'widget-solar-charger',
  ...
  it('builds dual y-axes for solar graphs and colors axis titles by metric', () => {
    (component as unknown as {
      data: {
        widget: IWidget;
      };
      ...
      seriesDefinitions: [
        {
          ...
          seriesUuid: 'widget-solar-1:solar-template',
          ownerWidgetUuid: 'widget-solar-1',
          ownerWidgetSelector: 'widget-solar-charger',
      ...
      seriesDefinitions: [
        {
          ...
          seriesUuid: 'widget-bms-1:batteries-template',
          ownerWidgetUuid: 'widget-bms-1',
          ownerWidgetSelector: 'widget-bms',
      ...
      seriesDefinitions: [
        {
          ...
          seriesUuid: 'widget-charger-1:charger-template',
      ...
      seriesDefinitions: [
        {
          ...
          seriesUuid: 'widget-inverter-1:inverter-template',
        ...
        },
        {
          ...
          seriesUuid: 'widget-alternator-1:alternator-template',
  ...
  it('widens only the enumeration window while leaving the chart data window at the display window', async () => {
    ...
    // The graph data fetch still uses the 1-hour display window for every concrete.
  ...
  it('converts a display path with the server-resolved measure, not the stored convertUnitTo', async () => {
    ...
    const displaySeries: ISkipSeriesDefinition = {
      ...
      seriesUuid: 'widget-numeric-1:speed:default',
  ...
  it('keeps the stored convertUnitTo for a structural path and never resolves a server measure', async () => {
    ...
    const structuralSeries: ISkipSeriesDefinition = {
      ...
      seriesUuid: 'widget-numeric-1:cog:default',
      ownerWidgetUuid: 'widget-numeric-1',
      ownerWidgetSelector: 'widget-numeric',
